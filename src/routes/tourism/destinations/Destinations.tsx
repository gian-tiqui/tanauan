...
const Destinations: React.FC = () => {
  ...
  return (
    <div className="container p-3 pt-8 mx-auto">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-2">
        ...
        <div className="py-5 bg-white rounded shadow-xl lg:col-span-2 md:col-span-2 lg:px-5 sm:px-5 md:px-5">
          <p className="mb-6 text-3xl font-extrabold text-center">
            Map of Tanuan City
          </p>
          <Map />
        </div>
        <div className="py-5 bg-white rounded shadow-xl lg:col-span-2 md:col-span-2 lg:px-5">
          <div className="hidden sm:hidden md:block lg:block">
            <p className="mb-6 text-3xl font-extrabold text-center">
              Delicacies of Tanauan
            </p>
            <Swiper
              spaceBetween={15}
              slidesPerView={3}
